...
Respective experiments on Ni/Cu(001) with threshold PEEM revealed that the magnetic contrast is very small\todo[inline]{Give number} and therefore might not be sufficient for ultrafast imaging \todo[inline]{Add reference}.
